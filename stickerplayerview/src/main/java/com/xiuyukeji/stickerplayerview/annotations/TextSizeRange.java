...
import static com.xiuyukeji.stickerplayerview.annotations.TextSizeRange.TEXT_SIZE_TO;
 ...
 */
@IntRange(from = TEXT_SIZE_FROM, to = TEXT_SIZE_TO)
@Retention(RetentionPolicy.SOURCE)
public @interface TextSizeRange {
    int TEXT_SIZE_FROM = 12, TEXT_SIZE_TO = 120;
}